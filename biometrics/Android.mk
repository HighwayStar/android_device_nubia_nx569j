...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.biometrics.fingerprint@2.0-service.nubia_nx569j
LOCAL_INIT_RC := android.hardware.biometrics.fingerprint@2.0-service.nubia_nx569j.rc
